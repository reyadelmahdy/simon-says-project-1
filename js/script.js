...
greenSection.addEventListener('click', function (event) {
  if (on) {
    playerOrder.push(1);
    check();
    green();
...
redSection.addEventListener('click', function (event) {
  if (on) {
    playerOrder.push(2);
    check();
    red();
...
yellowSection.addEventListener('click', function (event) {
  if (on) {
    playerOrder.push(3);
    check();
    yellow();
...
blueSection.addEventListener('click', function (event){
  if (on) {
    playerOrder.push(4);
    check();
    blue();
